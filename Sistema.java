...
import model.persistence.entities.ListaShow;
import model.persistence.entities.Show;
import model.persistence.persistence.GerenciadorArquivo;
import view.Console;

public class Sistema {

    static ArrayList<Show> listaShows = ListaShow.getListaShows();
    ...
    private static void atualizarShow() {
        ...
        try {
            ...
            ListaShow.verificarListaVazia();

            System.out.println("\nInforme o nome da turnê que deseja atualizar:");
            String nomeTurne = Console.lerString("Nome da Turnê");

            Show tempShow = ListaShow.buscarShow(nomeTurne);

            System.out.println("\nShow Localizado:" +
            tempShow.exibirDados() + "\nInforme novos dados:\n");
    ...
    private static void apagarShow() {
        ...
        try {
            ...
            ListaShow.apagarShow(tempShow);
            GerenciadorArquivo.salvarShowNoArquivo(listaShows);

            System.out.println("\nShow localizado: " + tempShow.exibirDados());
            
            System.out.println("\nShow " + tempShow.getNomeTurne() + 
